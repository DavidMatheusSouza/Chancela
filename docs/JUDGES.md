...
| 10 minutes | Clone, `pnpm verify:all`, `pnpm example:agent` | 313 tests, and a real agent being stopped over MCP |
...
pnpm install
pnpm verify:all          # typecheck + 313 tests, Foundry fuzzing included (needs Foundry)
